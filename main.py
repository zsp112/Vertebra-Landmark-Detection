...
def parse_args():
    ...
    parser.add_argument('--init_lr', type=float, default=1.00e-5, help='Init learning rate')
    ...
    parser.add_argument('--resume', type=str, default='model_60.pth', help='weights to be resumed')
